    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplicityTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationId = table.Column<int>(type: "int", nullable: false),
                    ComplicityTypeId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreventiveMeasureDecisions_Criminals_CriminalId",
                        column: x => x.CriminalId,
                        principalTable: "Criminals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CriminalCriminalCase",
                columns: table => new
                {
                    CriminalCasesId = table.Column<int>(type: "int", nullable: false),
                    CriminalsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriminalCriminalCase", x => new { x.CriminalCasesId, x.CriminalsId });
                    table.ForeignKey(
                        name: "FK_CriminalCriminalCase_CriminalCases_CriminalCasesId",
                        column: x => x.CriminalCasesId,
                        principalTable: "CriminalCases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriminalCriminalCase_Criminals_CriminalsId",
                        column: x => x.CriminalsId,
                        principalTable: "Criminals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InspectionMaterialDecisionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.InspectionMaterialDecisionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriminalCriminalCase_CriminalsId",
                table: "CriminalCriminalCase",
                column: "CriminalsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriminalStatusHistories_ComplicityTypeId",
                table: "CriminalStatusHistories",
                column: "ComplicityTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CriminalStatusHistories_CriminalId",
                table: "CriminalStatusHistories",
                column: "CriminalId");

            migrationBuilder.CreateIndex(
                name: "IX_CriminalStatusHistories_CriminalStatusId",
                table: "CriminalStatusHistories",
                column: "CriminalStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionMaterialMovements_InspectionMaterialDecisionId",
                table: "InspectionMaterialMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreventiveMeasureDecisions_CriminalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreventiveMeasureDecisions_PreventiveMeasureId",
                table: "PreventiveMeasureDecisions",
